...
<body class="bg-[#f7f9fa] text-[#004a6e]">
	...
	<main class="relative block overflow-hidden mt-28">
		...
		<section
			...
			<div class="max-w-xl flex flex-col gap-6">
				...
				<h1 class="text-3xl md:text-4xl font-semibold leading-tight">
					Building Futures Through Expert-Led, Job-Ready Training by Envision
					Computer Training Institute Pune</h1>
				<p class="text-[1rem] md:text-base leading-relaxed text-[#00405f]">
					Welcome to Envision Computer Training Institute Pvt. Ltd. (ECTIPL)
					Kickstart your career as a fresh graduate with our Lifetime Job
					Assistance courses in Full Stack Development and CAD. Envision
					Computer Training Institute Pune has been a leading destination for
					IT courses and job-ready training since 1999. Our comprehensive
					training programs empower you with the latest skills and hands-on
					experience in these high-demand fields. Our industry-aligned
					curriculum, expert instructors, and strong industry connections
					ensure that you secure a promising job upon completion. Join us
					today at Envision Computer Training Institute Pvt. Ltd. (ECTI)</p>
		...
		<!-- about us section -->
		<section
			class="max-w-7xl mx-auto my-10 bg-[#e4f1f6]  items-center rounded-2xl px-6 py-10 flex flex-col md:flex-row gap-10 md:gap-16 lg:gap-24 relative overflow-hidden"
			...
			<!-- Larger Image at Bottom 
							src="${pageContext.request.contextPath}/images/logonew.png"
			 -->
			<div
				class="w-full md:w-1/2 flex justify-center items-center relative z-0 px-4 py-4"
				data-aos="fade-left" data-aos-duration="1200">

				<img
					src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgB77Pmx_7cyNY3Tb6eNzIgm9kcuWHJUOiuA&s"
					...
					class="w-full max-w-[460px] h-auto rounded-xl object-contain md:absolute md:bottom-0"
		...
		<section class="w-full px-4 py-16 ">
			<div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
				...
				<!-- Vision Card -->
				<div
					class="relative group overflow-hidden p-6 rounded-xl bg-white shadow-lg border-l-4 border-green-500 transition-all duration-300 hover:shadow-2xl"
					data-aos="fade-right" data-aos-duration="1000">

					<!-- Decorative Gradient Hover Effect -->
					<div
						class="absolute inset-0 bg-gradient-to-br from-green-100 via-green-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl z-0"></div>
          ...
          <path stroke-linecap="round" stroke-linejoin="round"
					...
					<!-- Title -->
					<h2 class="text-2xl font-bold text-green-700 relative z-10 mb-3">Our
						Vision</h2>

					<!-- Description -->
					<p class="text-gray-700 relative z-10 leading-relaxed">To be
						recognized and respected as one of the premium associations of
						technical support with well-groomed students, exemplifying
						technical excellence among training institutions in Pune.</p>
				</div>

				<!-- Mission Card -->
				<div
					class="relative group overflow-hidden p-6 rounded-xl bg-white shadow-lg border-l-4 border-cyan-600 transition-all duration-300 hover:shadow-2xl"
					data-aos="fade-left" data-aos-duration="1000">

					<!-- Decorative Gradient Hover Effect -->
					<div
						class="absolute inset-0 bg-gradient-to-br from-cyan-100 via-cyan-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl z-0"></div>

					<!-- Icon -->
					<div class="relative z-10 mb-4">
						<svg class="w-12 h-12 text-cyan-600" fill="none"
							stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round"
					...
					<!-- Title -->
					<h2 class="text-2xl font-bold text-cyan-700 relative z-10 mb-3">Our
						Mission</h2>

					<!-- Description -->
					<p class="text-gray-700 relative z-10 leading-relaxed">To
						provide quality education, equipping students with
						industry-relevant skills, enhancing professionalism and
						productivity, and offering job assistance through our expert and
						committed team.</p>
				</div>
		...
		<section class="py-16 px-4 md:px-12" data-aos="fade-up"
			...
			<div class="max-w-6xl mx-auto">
				...
				<p class="text-lg text-gray-700 mb-6 leading-relaxed"
					data-aos="fade-up" data-aos-delay="100">
					At <strong class="text-[#004466]">Envision Computer
						Training Institute (ECTI)</strong>, we don’t just train you—we guide you
					all the way to your first job and beyond. Our placement program is
					one of the strongest in Pune, offering <strong>lifetime
						job assistance</strong> to every student. Thanks to our tie-ups with top IT
					companies, your skills don’t just stay on paper—they turn into <strong>real,
						rewarding careers</strong>.
				</p>
		    ...
		    function checkCounters() {
		      counters.forEach((counter) => {
		        if (isInViewport(counter)) {
		          animateCounter(counter); // Always animate when in view
		        }
		      });
		    }
